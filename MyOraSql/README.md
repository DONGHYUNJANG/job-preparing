...
- `user_indc.sql` : `t`(TABLE_NAME, blank=all)
- `user_cons.sql` : `t`(TABLE_NAME, blank=all)
- `user_concols.sql` : `t`(TABLE_NAME)
...
- `user_tbs_p.sql` : `t`(TABLE_NAME)
- `user_idx_p.sql` : `t`(TABLE_NAME)
- `user_seg.sql` : `sn`(SEGMENT_NAME, blank=all)

- `dba_tbs.sql` : `o`(OWNER)
- `dba_idx.sql` : `o`(OWNER)
- `dba_indc.sql` : `o`(OWNER)
- `dba_cons.sql` : `o`(OWNER)
- `dba_concols.sql` : `o`(OWNER)
- `dba_views.sql` : `o`(OWNER)
- `dba_seqs.sql` : `o`(OWNER)
- `dba_prog.sql` : `o`(OWNER)
- `dba_trigs.sql` : `o`(OWNER)
- `dba_tbs_p.sql` : `o`(OWNER)
- `dba_idx_p.sql` : `o`(OWNER)
