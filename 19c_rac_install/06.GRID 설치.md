...
![image](images/320294029-6f5b8a53-76ff-498c-8438-a22a44133434.png)
...
![image](images/320706357-674e3114-7a2b-4159-9d96-a23f674e2958.png)

![image](images/320707232-0c1ad1ef-5c68-40c3-b2c8-4453e262640c.png)
...
![image](images/320385366-f953fe2c-e3ce-4484-82c9-2bc602244109.png)

![image](images/320385434-c10c0e50-4e4e-4f20-952b-02ef8369a862.png)

![image](images/320385277-17b9297e-0aeb-46b7-8613-94cd099a6d24.png)

클러스터명과 SCAN 이름을 입력한다.

![image](images/320386277-6804e2ce-836f-42af-890b-4de592f34190.png)

Add를 눌러 2번노드에 대한 정보를 입력한다.

![image](images/320388891-7215ac92-4f98-4832-8bf8-bba83fef7264.png)

SSH Connectivity를 누르고 oracle 유저의 패스워드를 입력한 뒤 Test를 해본다.

![image](images/320411011-a38c071b-2053-4911-bea3-131e200614f9.png)
...
![image](images/320411284-4808768a-b8a1-4f57-bd7d-eaff783e8854.png)


Public, ASM & Private로 설정한다.

![image](images/320411474-4beaf229-74ed-49d2-8323-fe0ebfe5eb07.png)

![image](images/320411562-cbadadf9-b1b9-4c27-a73b-b8ce46d5b501.png)

No 선택

![image](images/320412579-ea383fe8-be6a-4c53-b254-52fe6ba0822c.png)

디스크 그룹 이름을 CRS로 설정하고 Normal을 선택한다.

만약 경로가 나오지 않으면 Change Discovery Path를 누르고 /dev/oracleasm/disks 를 입력한다.

![image](images/320413061-d4423a40-f51c-4e89-89e3-9c7607c3c64e.png)

CRS1,2,3을 선택하고 다음으로 넘어간다.

![image](images/320413421-38135444-cde8-42e6-8f11-1dfd00f64df7.png)

SYSASM의 비밀번호를 oracle로 입력한다.

![image](images/320413661-d1b35b90-58de-4c56-939e-a5f555b53717.png)

Do not use IPMI를 선택한다.

![image](images/320413811-3d656a11-bf2c-4a86-a774-034eb419ec11.png)

EM을 체크하지 않고 다음으로 넘어간다.

![image](images/320413930-07033fac-b305-4bc0-9b4f-d1a1a0f3077a.png)

그룹을 dba로 설정한다.

![image](images/320414159-abd6047c-15ad-463b-b3c6-83b9e3babc0b.png)

Yes 선택한다.

![image](images/320414462-d3859680-97a3-475d-8ff7-263eb52e04d5.png)

Oracle Base를 설정한다.

![image](images/320755863-61a3a70c-ff41-4d46-ae8c-4d644bbb7a83.png)

![image](images/320416008-17aa4e92-7b47-4540-bca8-8796e56a8bae.png)

orainventory를 지정한다.

![image](images/320416291-f2be9eb6-cfbb-4146-8ace-9d50a8d5ee76.png)

클러스터 구성 과정 중 root 계정으로 스크립트를 실행하는데, 자동으로 구성 스크립트를 실행하기 위해 root 계정의 비밀번호를 입력해준다.

![image](images/320416690-a610a2ce-bde5-4153-80a7-171e3e1a3b13.png)

설치 전 필요조건을 검사한다.

![image](images/320761093-ac076ea3-c0b2-4a0d-8cf4-ae9ca1893e7b.png)
...
![image](images/320761282-cf17c02b-9367-46fd-8d1c-ca65d19c3ce1.png)

![image](images/320421507-96dd2b96-9947-4a54-b0af-9bc3156abb6e.png)

설치를 시작한다.

![image](images/320422299-ccce6903-3075-40d1-aab5-5c67887e673d.png)

확인 창이 뜨면 Yes 한다.

![image](images/320783821-4b68e123-8919-460c-9725-fca70f538303.png)


SCAN IP가 DNS에 등록되어 있지 않아 생긴 에러. 무시한다.

![image](images/320784012-1d1109c1-c570-46af-bec2-16c48f84a4d8.png)
...
![image](images/320784868-7864ba99-cfdd-4a0e-b9ba-c23a338b9e18.png)
...
```
![image](images/320785775-41ca6ad0-03b6-40e0-8f37-f8535f7b4718.png)
...
![image](images/322224579-6037eb65-115e-421a-b53e-4fd5169cab66.png)

![image](images/322224295-7c499491-ab6a-4d99-a2fb-8e6357a68087.png)
